...
//MODIFICARI
//3:componenta descrisa mai jos este in prea stransa legatura cu pagina principala(se puteau crea mai multe componente mai mici care puteau explica mai bine, pas cu pas procedeele)


//5:deoarece codul a fost scris de catre programatori neexpermientati, exista sansa ca acesta sa nu fie atat de "lizibil",
//asa ca i-ar lua mai mult timp unui coleg experimentat sa identifice anumite greseli evidente in cazul unui cod clean 
...
class formBug2 extends Component {
    constructor() {
        ...
        this.state = {
            ...
            loading: false,
            loaded: false,
//1:spatiere(linii goale inainte de inchiderea parantezei)




        }
        //2:spatiere(liniile 28-34: initializarile sunt prea ingramadite si se pot lasa 1-2 linii spatiu intre ele)
        //4:daca eliminam variabila postBug va trebui sa facem modificari in tot proiectul
    ...
    componentDidUpdate(prevProps, prevState) {
        ...
        //6: existenta comentariilor pe cod nu este insotita de explicatii care ar usura intelegerea sa
